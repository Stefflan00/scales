...
(function() {
  this.JST || (this.JST = {});
  this.JST["app/controllers/log"] = (function() {
    var __hasProp = {}.hasOwnProperty,
      __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  
    App.Log = (function(_super) {
  
      __extends(Log, _super);
  
      Log.prototype.elements = {
        '#events': 'eventsDiv'
      };
      ...
      Log.prototype.deactivate = function() {
        this.el.removeClass("active");
      ...
      Log.prototype.bindEvents = function() {
        var _this = this;
        Spine.bind('server_started', function(event) {
          return _this.add(event);
        });
        Spine.bind('server_stopped', function(event) {
          return _this.add(event);
        });
        Spine.bind('worker_started', function(event) {
          return _this.add(event);
        });
        Spine.bind('worker_stopped', function(event) {
          return _this.add(event);
        });
        Spine.bind('cache_started', function(event) {
          return _this.add(event);
        });
        Spine.bind('cache_stopped', function(event) {
          return _this.add(event);
        });
        Spine.bind('server_put_request_in_queue', function(event) {
          return _this.add(event);
        });
        Spine.bind('server_took_response_from_queue', function(event) {
          return _this.add(event);
        });
        Spine.bind('worker_took_request_from_queue', function(event) {
          return _this.add(event);
        });
        Spine.bind('worker_put_response_in_queue', function(event) {
          return _this.add(event);
        });
        Spine.bind('push_resource', function(event) {
          return _this.add(event);
        });
        Spine.bind('destroy_resource', function(event) {
          return _this.add(event);
        });
        Spine.bind('push_partial', function(event) {
          return _this.add(event);
        });
        return Spine.bind('destroy_partial', function(event) {
          return _this.add(event);
        });
      };
  
      Log.prototype.render = function(event) {
        return this.html(JST['app/views/log'](this));
      };
      ...
      Log.prototype.add = function(event) {
        ...
        for (item in event) {
          data = event[item];
          if (item === "key" || item === "safe" || item === "escape" || item === "server" || item === "color" || item === "type") {
  ...
  App.Machines = (function(_super) {
    ...
    Machines.prototype.bindEvents = function() {
      ...
      Spine.bind('server_started', function(server) {
        ...
        return _this.renderMachines(_this.servers, _this.serversDiv);
      });
      Spine.bind('server_stopped', function(server) {
        delete _this.servers[server.id];
        return _this.renderMachines(_this.servers, _this.serversDiv);
      });
      Spine.bind('worker_started', function(worker) {
        _this.workers[worker.id] = worker;
        return _this.renderMachines(_this.workers, _this.workersDiv);
      });
      Spine.bind('worker_stopped', function(worker) {
        delete _this.workers[worker.id];
        return _this.renderMachines(_this.workers, _this.workersDiv);
      });
      Spine.bind('cache_started', function(cache) {
        _this.caches[cache.id] = cache;
        return _this.renderMachines(_this.caches, _this.cachesDiv);
      });
      return Spine.bind('cache_stopped', function(cache) {
        delete _this.caches[cache.id];
        return _this.renderMachines(_this.caches, _this.cachesDiv);
      });
    };
...
(function() {
  ...
  App.Resources = (function(_super) {

    __extends(Resources, _super);

    Resources.prototype.elements = {
    ...
    Resources.prototype.bindColors = function() {
      return this.colors = {
        'HTML': '#EDFFA3',
        'CSS': '#A3E2FF',
        'JS': '#FFDAA3',
    ...
    Resources.prototype.bindEvents = function() {
      var _this = this;
    ...
    Resources.prototype.render = function() {
      return this.html(JST['app/views/resources'](this));
    };

    Resources.prototype.renderResources = function(resources, div) {
      var id, out, resource, resourceAmount, resourcesArray, server, _i, _len, _ref;
      resourceAmount = 0;
      for (id in resources) {
      ...
      resourcesArray.sort(function(a, b) {
      ...
      this.i = 0;
      for (_i = 0, _len = resourcesArray.length; _i < _len; _i++) {
        resource = resourcesArray[_i];
        if (this.i === 0) {
          out += "<div class='row'>";
        }
        resource.color = this.colors[resource.format];
        _ref = this.servers;
        for (id in _ref) {
          server = _ref[id];
      ...
      return this.renderContentTypes();
    };

    Resources.prototype.processContentTypes = function() {
      var format, formats, formatsArray, id, model, partial, resource, total, _ref, _ref1;
      formats = {};
      total = 0;
      _ref = this.resources;
      for (id in _ref) {
        ...
        if (!formats[resource.format]) {
          ...
          formats[resource.format].amount += 1;
        }
      }
      _ref1 = this.partials;
      for (id in _ref1) {
        partial = _ref1[id];
        total += 1;
        if (!formats[partial.format]) {
          formats[partial.format] = {
            amount: 1
          };
        } else {
          formats[partial.format].amount += 1;
        }
      }
      formatsArray = [];
      for (format in formats) {
        ...
        model.color = this.colors[model.format];
        formatsArray.push(model);
      }
      formatsArray.sort(function(a, b) {
    ...
    Resources.prototype.renderContentTypes = function() {
      ...
      for (_i = 0, _len = formats.length; _i < _len; _i++) {
        format = formats[_i];
        out += JST['app/views/_format_bar'](format);
      }
      return this.contentTypesDiv.html(out);
    };
...
(function() {
  this.JST || (this.JST = {});
  this.JST["app/views/_format_bar"] = function(__obj) {
    if (!__obj) __obj = {};
    ...
    (function() {
      (function() {
        ...
        __out.push('<div class="progress color" style="text-align: center;">\n  \n  <div class="span4 overlay">\n    <span style="float:left; margin-left:20px;">');
      
        __out.push(__sanitize(this.format));
      
        __out.push('</span>\n    <span class="pull-right" style="margin-right:20px;">');
      
        __out.push(__sanitize(Math.round(this.progress * 100) / 100));
      
        __out.push('%</span>\n    <span class="pull-right" style="margin-right:115px;">');
      
        __out.push(__sanitize(this.amount));
      
        __out.push('</span>\n  </div>\n  \n  <div class="bar color" style="width: ');
      
        __out.push(__sanitize(this.progress));
      
        __out.push('%; background-color: ');
  ...
  this.JST["app/views/_machine"] = function(__obj) {
    ...
    (function() {
      (function() {
        ...
        __out.push('\n    <small class="pull-right"><i class="icon-off"></i> <time class="timeago" datetime="');
      
        __out.push(__sanitize(JSON.parse(JSON.stringify(new Date(this.spawned_at * 1000)))));
  ...
  this.JST["app/views/_resource"] = function(__obj) {
    ...
    (function() {
      (function() {
        ...
        __out.push('<div class="span1 pagination-centered">\n  <div class="well block" style="background-color:');
      
        __out.push(__sanitize(this.color));
      
        __out.push('">\n    <a href="');
      
        __out.push(__sanitize(this.server != null ? "http://" + this.server.ip + ":" + this.server.port + this.path : "#/resources"));
      
        __out.push('" rel="tooltip" title="');
...
(function() {
  this.JST || (this.JST = {});
  this.JST["app/views/log"] = function(__obj) {
    if (!__obj) __obj = {};
    var __out = [], __capture = function(callback) {
      var out = __out, result;
      __out = [];
    ...
    (function() {
      (function() {
        ...
        __out.push('<header class="jumbotron subhead">\n  <h1>Log</h1>\n  <p class="lead">Live Event Log of the whole System</p>\n</header>\n\n<section>\n  \n  <div class="page-header"><h1>Events</h1></div>\n  <div id="events" class="log well">Initializing ...</div>\n\n</section>\n');
...
(function() {
  this.JST || (this.JST = {});
  this.JST["app/views/resources"] = function(__obj) {
    if (!__obj) __obj = {};
    var __out = [], __capture = function(callback) {
      var out = __out, result;
      __out = [];
